...
After you install the repository, you can delete files other than wiki.js! wiki.py will look empty but it kinda keeps the entire thing working, if you encounter any issues, please do say in the "issues" place! this code can work on python if you send the file AFTER doing the process!
